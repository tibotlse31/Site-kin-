...
function renderEye(model) {
  ...
  const horizontalArrow = (() => {
    ...
    // Important: right/left are clinical directions (patient), while the eye is drawn front-facing.
    // So a right-beating nystagmus is rendered to the left side of the screen, and vice versa.
  ...
  const verticalArrow = (() => {
    ...
    return model.vertical === 'down'
      ? `<line x1="214" y1="68" x2="214" y2="140" stroke="#dc2626" stroke-width="5" stroke-linecap="round" ${dash} marker-end="url(#arrowRed)"/>`
      : `<line x1="214" y1="140" x2="214" y2="68" stroke="#dc2626" stroke-width="5" stroke-linecap="round" ${dash} marker-end="url(#arrowRed)"/>`;
  })();

  const torsion = (() => {
    if (model.type !== 'torsional-vertical') return '';
    if (model.torsion === 'horaire') {
      return `<path d="M 106 132 Q 82 104 106 76" fill="none" stroke="#dc2626" stroke-width="5" stroke-linecap="round" marker-end="url(#arrowRed)"/>`;
    }
    return `<path d="M 174 132 Q 198 104 174 76" fill="none" stroke="#dc2626" stroke-width="5" stroke-linecap="round" marker-end="url(#arrowRed)"/>`;
  })();

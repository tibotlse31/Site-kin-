window.COURSE_DATA = {
  channels: {
    ...
    horiz: {
      ...
      symptoms: [
        'Différencier canalolithiase et cupulolithiase.',
        'Canalolithiase : latence, nystagmus paroxystique, symptômes < 1 min.',
        'Cupulolithiase : pas de latence, nystagmus persistant, symptômes > 1 min tant que la position est maintenue.'
      ],
      diagnostic: {
        ...
        nystagmus: 'Nystagmus horizontal géotropique ou agéotropique selon la position des otolithes.',
        sideRule: 'Géotropique : plus intense côté atteint. Agéotropique : plus intense côté sain.',
        conclusion: 'Choisir Lempert surtout pour les formes géotropiques, Gufoni 3G ou 3A selon la forme.'
      },
      treatmentLink: ['Lempert', 'Gufoni 3G', 'Gufoni 3A'],
      restrictions: [
        'Dormir côté sain ou sur le dos selon la stratégie choisie.',
        'Éviter de se pencher en avant visage parallèle au sol après Lempert.',
    ...
    ant: {
      ...
      diagnostic: {
        ...
        nystagmus: 'Nystagmus vertical inférieur, parfois avec composante torsionnelle utile à la latéralisation.',
      ...
      redFlags: [
        'Downbeat nystagmus pouvant être d’origine centrale.',
  ...
  treatments: [
    {
      id: 'semont', canal: 'post', name: 'Manœuvre de Sémont',
      indication: 'VPPB du canal postérieur confirmé, utile notamment si mobilité cervicale limitée.',
      expected: 'Nystagmus thérapeutique torsionnel agéotropique lors de la bascule opposée.',
      steps: [
      ...
      aftercare: ['Dormir côté sain.', 'Limiter les mouvements du plan pitch.', 'Relever prudemment.']
    },
    {
      id: 'epley', canal: 'post', name: 'Manœuvre d’Épley',
      ...
      mistakes: ['Transitions trop rapides sans maintien.', 'Mauvais ordre des positions.', 'Répéter la manœuvre sans réévaluation.'],
      aftercare: ['Dormir côté sain.', 'Éviter le plan antéro-postérieur.', 'Respecter une pause après la manœuvre.']
    },
    {
      id: 'lempert', canal: 'horiz', name: 'Barbecue de Lempert',
      ...
      mistakes: ['Tourner du mauvais côté.', 'Oublier les pauses de maintien.', 'Négliger la sécurité au retour assis.'],
      aftercare: ['Dormir côté sain ou sur le dos.', 'Relever le bord latéral de l’oreiller côté VPPB si demandé.', 'Éviter de se pencher en avant visage parallèle au sol.']
    },
    {
      id: 'gufoni3g', canal: 'horiz', name: 'Gufoni 3G',
      ...
      steps: [
        ...
        'Bascule rapide en décubitus latéral strict sur le bon côté.',
        'Rotation de tête à 90° vers la table.',
        'Maintien puis relever en conservant la rotation, avant retour tête dans l’axe.'
      ],
      mistakes: ['Se tromper de côté de bascule.', 'Appui sur la caméra si équipement vidéo.', 'Rotation de tête insuffisante.'],
      aftercare: ['Dormir du côté prescrit après Gufoni.', 'Éviter de se pencher en avant.']
    },
    {
      id: 'gufoni3a', canal: 'horiz', name: 'Gufoni 3A',
      ...
      mistakes: ['Prendre le côté sain au lieu du côté atteint.', 'Ne pas reconnaître une conversion canalaire.', 'Confondre forme agéotropique et géotropique.'],
      aftercare: ['Dormir du côté indiqué.', 'Réévaluer si le nystagmus change de direction après manœuvre.']
    },
    {
      id: 'yacovino', canal: 'ant', name: 'Manœuvre de Yacovino',
      indication: 'Canal antérieur non latéralisé ou diagnostiqué au Deep Head Hanging.',
      expected: 'Nystagmus vertical inférieur suivi d’une inversion au redressement/flexion selon la séquence.',
      steps: [
      ...
      mistakes: ['Aller trop vite entre les positions.', 'Ignorer une contre-indication cervicale.', 'Oublier que le côté n’a pas besoin d’être identifié.'],
      aftercare: ['Surveillance clinique.', 'Réévaluer si downbeat atypique ou persistant.']
    },
    {
      id: 'li', canal: 'ant', name: 'Manœuvre de Li',
      ...
      mistakes: ['Négliger la sécurité cervicale.', 'Durée de maintien insuffisante.'],
      aftercare: ['Contrôle clinique secondaire.']
    },
    {
      id: 'kim', canal: 'ant', name: 'Kim / Épley inversé',
      ...
      mistakes: ['Latéralisation erronée.', 'Confusion avec un traitement de canal postérieur standard.'],
      aftercare: ['Réévaluation du nystagmus de contrôle.']
    }
  ],
  ...
  checklists: {
    post: {
      diagnostic: [
        ...
        'Rotation de tête à 45° et extension cervicale correcte.',
        'Observer la forme torsionnelle géotropique.',
        'Vérifier l’inversion au retour assis.'
      ],
      therapeutic: [
        'Confirmer le diagnostic avant de traiter.',
        'Respecter la séquence complète de la manœuvre choisie.',
        'Observer le nystagmus thérapeutique attendu.',
        'Prévoir une pause avant le relever.',
    ...
    ant: {
      diagnostic: [
        'Confirmer que le tableau évoque bien un canal antérieur.',
  ...
  cases: [
    {
      id: 'post1', canal: 'post', title: 'Cas 1 — canal postérieur',
      ...
      reasoning: ['Vertige bref et positionnel.', 'Dix-Hallpike positif du côté droit.', 'Nystagmus torsionnel géotropique typique d’un postérieur.']
    },
    {
      id: 'post4', canal: 'post', title: 'Cas 4 — bilatéral à prédominance droite',
      ...
      reasoning: ['Positivité bilatérale.', 'Intensité plus marquée à droite = priorité à droite.', 'Le côté controlatéral se gère après contrôle du premier côté.']
    },
    {
      id: 'horiz9', canal: 'horiz', title: 'Cas 9 — géotropique gauche',
      ...
      answer: 'Oreille gauche atteinte. Forme géotropique du canal horizontal gauche. Traitement par Gufoni côté sain (droite) ou Barbecue de Lempert vers la droite.',
      reasoning: ['Géotropique = le côté le plus intense est le côté atteint.', 'Plus intense à gauche = gauche atteinte.']
    },
    {
      id: 'horiz10', canal: 'horiz', title: 'Cas 10 — agéotropique gauche',
      ...
      answer: 'Évoquer un Bow and Lean complémentaire. En agéotropique, le côté le plus fort est le côté sain, donc oreille gauche atteinte. On choisit Gufoni 3A à gauche.',
      reasoning: ['Agéotropique = côté le plus intense = côté sain.', 'Plus fort à droite = côté sain droit, donc oreille gauche atteinte.']
    },
    {
      id: 'ant13', canal: 'ant', title: 'Cas 13 — antérieur droit',
      ...
      reasoning: ['Vertical inférieur = orientation vers canal antérieur.', 'La torsion aide ici à latéraliser.']
    },
    {
      id: 'ant15', canal: 'ant', title: 'Cas 15 — conversion canalaire',
      ...
      reasoning: ['Le downbeat secondaire après Épley évoque une conversion antérieure.', 'Il faut changer de logique thérapeutique.']
    }
  ],
    ...
    post: {
      tests: {
        dixhallpike: {
          name: 'Dix-Hallpike',
          steps: [
            { title: 'Départ assis', text: 'Tête tournée à 45° vers le côté testé. Pas de nystagmus attendu au repos.', nystagmus: 'Aucun nystagmus', shape: 'neutral' },
            { title: 'Passage couché', text: 'Extension cervicale. Déclenchement d’un nystagmus torsionnel vertical supérieur du côté testé s’il est atteint.', nystagmus: 'Torsionnel géotropique', shape: 'post-provoked' },
            { title: 'Retour assis', text: 'Inversion du nystagmus au redressement.', nystagmus: 'Inversion du nystagmus', shape: 'post-return' }
          ],
    ...
    horiz: {
      tests: {
        bowlean: {
          name: 'Bow and Lean',
          steps: [
            { title: 'Tête droite assise', text: 'Observer un éventuel pseudo-spontané avant le test.', nystagmus: 'Base de comparaison', shape: 'neutral' },
            { title: 'Bow', text: 'Canalolithiase : le nystagmus bat vers l’oreille atteinte. Cupulolithiase : vers l’oreille saine.', nystagmus: 'Horizontal', shape: 'bow' },
            { title: 'Lean', text: 'Le sens s’inverse : canalolithiase vers l’oreille saine, cupulolithiase vers l’oreille atteinte.', nystagmus: 'Horizontal inversé', shape: 'lean' }
          ],
        ...
        supineroll: {
          ...
          steps: [
            { title: 'Position centrale', text: 'Décubitus dorsal tête à 30° de flexion. Observation de base.', nystagmus: 'Base de comparaison', shape: 'neutral' },
            { title: 'Rotation droite', text: 'Comparer l’intensité et le sens du nystagmus.', nystagmus: 'Horizontal géotropique ou agéotropique', shape: 'roll-right' },
            { title: 'Rotation gauche', text: 'Comparer au côté opposé pour déterminer le côté atteint.', nystagmus: 'Horizontal géotropique ou agéotropique', shape: 'roll-left' }
          ],
          interpretation: 'Géotropique : plus intense côté atteint. Agéotropique : plus intense côté sain.'
        },
        upright: {
          name: 'Upright Head Roll',
          steps: [
            { title: 'Tête droite', text: 'Position assise de départ.', nystagmus: 'Aucun ou pseudo-spontané', shape: 'neutral' },
            { title: 'Inclinaison latérale', text: 'Géotropique : le nystagmus suit l’inclinaison du côté atteint. Agéotropique : il va en sens opposé.', nystagmus: 'Horizontal', shape: 'upright' }
          ],
    ...
    ant: {
      tests: {
        deephead: {
          ...
          steps: [
            { title: 'Départ assis', text: 'Tête droite avant la bascule.', nystagmus: 'Aucun nystagmus', shape: 'neutral' },
            { title: 'Head hanging', text: 'Nystagmus vertical inférieur, parfois pur, parfois accompagné d’une faible torsion.', nystagmus: 'Vertical inférieur', shape: 'ant-provoked' },
            { title: 'Retour assis', text: 'Une inversion peut être observée mais elle n’est pas toujours nette.', nystagmus: 'Possible inversion', shape: 'ant-return' }
          ],
